	...
	this.CheckQuests = function(ClearedArea){
		...
		switch(ClearedArea){
			...
			case 44://Amulet
				...
				Town.doChores();
				if(this.cubeStaff()){
					this.talkToNPC(177);//Drognan
					this.talkToNPC(201);//Jerhyn
			...
			case 111://Shenk
				...
				this.talkToNPC(511);//Larzuk
				this.logProgress(me.getQuest(35,0),"Shenk");
				this.talkToNPC(515);//Qual-Kehk
...
// =============== ACT II FUNCTIONS =============== //
	...
	this.talkToTyrael = function(){
		var i,NPC = getUnit(1,251);//Tyrael
