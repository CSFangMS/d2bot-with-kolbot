...
function LoadConfig() {
	...
	Scripts.BattleOrders = true;
		...
		Config.BattleOrders.Getters = ["sfsorc"]; // List of players to wait for before casting Battle Orders (mode 0). All players must be in the same area as the BOer.
